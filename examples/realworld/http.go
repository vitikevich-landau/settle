...
//     открывает новое — под нагрузкой это создаёт лишний churn соединений.
//     Поэтому остаток дочитывается, но не дальше drainLimit: см. его описание,
//     там же и обоснование размена.
