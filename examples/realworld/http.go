...
//   - тело всегда дочитывается и закрывается. Иначе соединение не вернётся в
//     пул и следующий запрос будет открывать новое — классическая утечка
//     сокетов под нагрузкой.
